...
| 2026-08-14 | `./gradlew :composeApp:compileKotlinDesktop --console=plain --no-daemon -Dorg.gradle.jvmargs='-Xmx1024m -Dfile.encoding=UTF-8' -Dorg.gradle.parallel=false` | pass | Android-derived two-layer word-by-word karaoke sweep, glow, and future-text masking compile successfully in common Compose Desktop. |
| 2026-08-14 | `./gradlew :composeApp:compileKotlinDesktop --console=plain --no-daemon -Dorg.gradle.jvmargs='-Xmx1024m -Dfile.encoding=UTF-8' -Dorg.gradle.parallel=false` | pass | Android-equivalent lyric-line tap-to-seek dispatch compiles successfully. |
| 2026-08-14 | `./gradlew :composeApp:compileKotlinDesktop --console=plain --no-daemon -Dorg.gradle.jvmargs='-Xmx1024m -Dfile.encoding=UTF-8' -Dorg.gradle.parallel=false` | pass | Android-equivalent active/past/upcoming lyric emphasis animation compiles successfully. |
| 2026-08-14 | `./gradlew :composeApp:compileKotlinDesktop --console=plain --no-daemon -Dorg.gradle.jvmargs='-Xmx1024m -Dfile.encoding=UTF-8' -Dorg.gradle.parallel=false` | pass | Empty lyric results now have a dedicated desktop fallback state rather than a blank surface. |
| 2026-08-14 | `./gradlew :composeApp:compileKotlinDesktop --console=plain --no-daemon -Dorg.gradle.jvmargs='-Xmx1024m -Dfile.encoding=UTF-8' -Dorg.gradle.parallel=false` | pass | Shared Compose port of Android's animated wavy seek slider compiles and is wired into mini/full player surfaces. |
| 2026-08-14 | `./gradlew :composeApp:compileKotlinDesktop --console=plain --no-daemon -Dorg.gradle.jvmargs='-Xmx1024m -Dorg.gradle.parallel=false` | pass | Desktop JCEF dependency, persisted YouTube Music cookie session, InnerTube runtime hydration, and embedded-browser cookie extraction compile successfully. |
| 2026-08-14 | `./gradlew :composeApp:compileKotlinDesktop --console=plain --no-daemon -Dorg.gradle.jvmargs='-Xmx1024m -Dorg.gradle.parallel=false` | pass | Desktop Account route now hosts the embedded JCEF YouTube Music login and captures its authenticated cookie session. |
| 2026-08-14 | `./gradlew :composeApp:compileKotlinDesktop --console=plain --no-daemon -Dorg.gradle.jvmargs='-Xmx1024m -Dorg.gradle.parallel=false` | pass | Desktop YouTube Music logout clears persistent InnerTube credentials and JCEF browser cookies. |
| 2026-08-14 | `./gradlew :composeApp:compileKotlinDesktop --console=plain --no-daemon -Dorg.gradle.jvmargs='-Xmx1024m -Dorg.gradle.parallel=false` | pass | JCEF page-finish callback now automatically captures authenticated YouTube Music cookies like Android WebView. |
